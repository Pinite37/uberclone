...
const Role = () => {
  ...
  return (
    <View style={roleStyles.container}>
      ...
      />
      <CustomText fontFamily='Medium' variant='h6' style={roleStyles.title}>
      ...
      <TouchableOpacity style={roleStyles.card} onPress={handleCustomerPress}>
        ...
        <View style={roleStyles.cardContent}>
            ...
            <CustomText fontFamily='Medium' variant='h6' style={roleStyles.description }>
                Are you a customer ? Order rides and delivery easily.
            </CustomText>
        </View>
      </TouchableOpacity>
